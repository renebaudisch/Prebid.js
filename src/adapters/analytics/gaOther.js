 ...
 * @param  {string} global GA global (if renamed);
 * @param {string} enableDistribution set distribution
 * @return {[type]}    [description]
 */
exports.enableAnalytics = function () {
  const gaOptions = this.config;

  _gaGlobal = gaOptions && gaOptions.global || 'gaOther';

  if (gaOptions && typeof gaOptions.enableDistribution !== 'undefined') {
